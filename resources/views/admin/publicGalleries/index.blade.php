...
@section('title-page') Galeries Publiques @endsection
...
@section('content')
    <section class="section section__table">
        <a href="{{ route('getFormPublicGallery') }}" class="button button__table button--black">
            <span class="icon">
            ...
            @foreach($galleries as $gallery)
                <tr class="table__tr">
                    ...
                    <td class="table__tr-action">
                        <a class="table__tr-btn" href="{{ route('updatePublicGallery', $gallery->id) }}">
                        ...
                        <form id="form-{{$gallery->id}}" class="form form__delete"
                              action="{{ route('destroyPublicGallery',$gallery->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
